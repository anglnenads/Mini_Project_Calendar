...
function checkInputs() {
	...
	if(endDValue === '') {
		...
		check = 0;
	} else if(endDValue <= startDValue){	
		setErrorFory(enddate, "End date can't be earlier than the start date");
		check = 0;
	} else {
...
/*Pembuatan class untuk mengatur penempatan pesan error karena tiap inputan pada labe memiliki class yang berbeda-beda*/
